...
int main() {
	...
	int i, j, l, h, v, k, st,sv, LABLE_1 = 12, binh1, binh2, binh3, peak, bincheck=0, region_c;
	...
	INPUTIC(N_IC, BIAS, BIN_I, BINSIZEA, BINSIZEB, BINSTEP, POINT_N, STEP, ERROR_T, REF_T, REF_DENSITY, dt);
	
	REACTION(N_IC, REF_DENSITY, REF_T, KV1, KV2, KV3, KV4, KH1, KH2, KH3, KE, KEI, KEV);
	
	DENSITY(N_IC, a, ae, av1, av2, av3, av4, ah1, ah2, ah3, gain_e,local_lost,
			pa, pb, L, s, se, sv1, sv2, sv3, sv4, sh1, sh2, sh3);
